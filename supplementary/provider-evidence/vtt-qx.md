...
|---|---|---|---|---|---|
| VTT quantum technology overview | Public documentation reviewed 2026-07-19 | Official documentation | https://www.vttresearch.com/en/ourservices/quantum-technology | 2026-07-19 | Platform overview; VTT 5-qubit and 20-qubit systems; research access model |
| VTT Q5sim / VTT QX service information | Public documentation reviewed 2026-07-19 | Official documentation | https://www.vttresearch.com/en/ourservices/quantum-technology | 2026-07-19 | System naming (Q5sim evolved to VTT QX); hardware specifications; access arrangements |
| IQM client SDK (open source) — applicable to VTT QX | IQM Client 34–35 support window for Q50 at cutoff | SDK source / package documentation | https://github.com/iqm-finland/iqm-client | 2026-07-19 | REST API client interface applicable to IQM-hardware systems including VTT QX; `RunRequest` and `RunResult` field structure |
| IQM documentation (applicable interface) | IQM Pulla 13–14 compatibility references at cutoff | Official documentation | https://docs.meetiqm.com/ | 2026-07-19 | IQM server REST API; measurement result structure; job status |
