...
|---|---|---|---|---|---|
| D-Wave documentation portal | Public documentation reviewed 2026-07-19 | Official documentation | https://docs.dwavesys.com/ | 2026-07-19 | Quantum annealing computation model; QPU topology; problem submission; solution structure |
| D-Wave Ocean SDK documentation | Ocean SDK 9.3.0 documentation | Official documentation | https://docs.ocean.dwavesys.com/ | 2026-07-19 | Problem formulation (QUBO/BQM/CQM); sampler interfaces; result `SampleSet` format; timing data |
| dwave-ocean-sdk (open source) | Ocean SDK 9.3.0 | SDK source / package documentation | https://github.com/dwavesystems/dwave-ocean-sdk | 2026-07-19 | Meta-package encompassing Ocean toolchain; release history |
| dwave-cloud-client (open source) | SAPI `/sapi/v2` client; version-3 solver representations | SDK source / package documentation | https://github.com/dwavesystems/dwave-cloud-client | 2026-07-19 | Leap API client; solver listing; problem submission; `Future` result object fields (`timing`, `num_occurrences`, `energy`, `sample`) |
| dwave-cloud-client PyPI releases | Ocean SDK 9.3.0 component releases | Package release page | https://pypi.org/project/dwave-cloud-client/ | 2026-07-19 | Published release history and version constraints |
| D-Wave Leap service documentation | SAPI `/sapi/v2`; version-3 solver representations | Official documentation | https://docs.dwavesys.com/docs/latest/c_leap.html | 2026-07-19 | Cloud service access model; solver types available (QPU, hybrid); access tiers |
